...
export const commands = {
	 ...
	 *  dependency.
	 */
	listAudioInputDevices: () => typedError<MicDevice[], BoothError>(__TAURI_INVOKE("list_audio_input_devices")),
	/**
...
export type AppSettings = {
	 ...
	 */
	prefer_builtin_mic_with_bluetooth?: boolean,
};
...
export type SettingsPatch = {
	...
	prefer_builtin_mic_with_bluetooth?: boolean | null,
};
