...
**Status:** pre-alpha. Hot path (mic → Whisper / Parakeet STT → LLM cleanup → paste) works on Windows and macOS, with persistent history, quick-paste palette, in-app Settings panel, and a developer-mode bench harness for grading STT/LLM swaps. Wave 5 (context-aware cleanup, Parakeet TDT 0.6B engine, captures-to-disk, in-app grading UI) is on `main`. **Next: Wave 6 — engine + formatting** on [`feat/wave-6-engine-and-formatting`](https://github.com/ebootheee/boothrflow/tree/feat/wave-6-engine-and-formatting): structure-aggressiveness style overhaul (raw / light / moderate / assertive), Nemotron Speech Streaming via sherpa-onnx, parakeet.cpp evaluation, bench harness hardening. Detailed plan at [`docs/waves/wave-6-engine-and-formatting.md`](./docs/waves/wave-6-engine-and-formatting.md). After Wave 6: production polish (Wave 7), then connectors + UI rebuild + privacy audit (Wave 8). See [`ROADMAP.md`](./ROADMAP.md).
...
| **Wave 6**: engine + formatting — structure-aggressiveness style overhaul, Nemotron Speech Streaming, parakeet.cpp evaluation, bench hardening       | Active on [`feat/wave-6-engine-and-formatting`](https://github.com/ebootheee/boothrflow/tree/feat/wave-6-engine-and-formatting) — plan at [`docs/waves/wave-6-engine-and-formatting.md`](./docs/waves/wave-6-engine-and-formatting.md) |
