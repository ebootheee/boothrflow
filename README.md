...
**Status:** pre-alpha. Hot path (mic → Whisper / Parakeet STT → LLM cleanup → paste) works on Windows and macOS, with persistent history, quick-paste palette, and an in-app Settings panel. Wave 5 (context-aware cleanup: app-context, focused-window OCR, auto-learning correction store, Parakeet TDT 0.6B engine) is in UAT on [`feat/wave-5`](https://github.com/ebootheee/boothrflow/tree/feat/wave-5). Next: structured / app-aware formatting (Wave 6) — see [`ROADMAP.md`](./ROADMAP.md).
...
| **Wave 6**: structured / app-aware formatting (auto-format style — bullets, paragraphs, code fences)                                                 | Next                                                                                                                                                                |
| **Wave 7**: production polish — code signing, auto-update, onboarding wizard                                                                         | Queued                                                                                                                                                              |
