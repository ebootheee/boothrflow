...
**Status:** pre-alpha. Hot path (mic → Whisper / Parakeet STT → LLM cleanup → paste) works on Windows and macOS, with persistent history, quick-paste palette, in-app Settings panel, and a developer-mode bench harness for grading STT/LLM swaps. **Wave 5 + Wave 6 Phase 0 are on [`feat/wave-6-engine-and-formatting`](https://github.com/ebootheee/boothrflow/tree/feat/wave-6-engine-and-formatting)** — structure-aggressiveness style picker (raw / light / moderate / assertive), Bluetooth-aware mic default, in-app bench grading UI, history dropdown UX. Wave 6 Phase 1+2+3 (Nemotron Speech Streaming, parakeet.cpp eval, bench N=3+median) still pending — plan at [`docs/waves/wave-6-engine-and-formatting.md`](./docs/waves/wave-6-engine-and-formatting.md). After Wave 6: production polish (Wave 7), then connectors + UI rebuild + privacy audit (Wave 8). See [`ROADMAP.md`](./ROADMAP.md).
...
| **Wave 6 Phase 0**: structure-aggressiveness style overhaul (raw / light / moderate / assertive) + Bluetooth-aware mic default + history dropdown UX + bench warmup | ✅ Shipped on [`feat/wave-6-engine-and-formatting`](https://github.com/ebootheee/boothrflow/tree/feat/wave-6-engine-and-formatting) — see [CHANGELOG](./CHANGELOG.md#2026-05-05--wave-6-phase-0--small-fixes-sweep) |
| **Wave 6 Phase 1+2+3**: Nemotron Speech Streaming, parakeet.cpp evaluation, bench N=3+median                                                                        | Pending — plan at [`docs/waves/wave-6-engine-and-formatting.md`](./docs/waves/wave-6-engine-and-formatting.md)                                                                                                      |
